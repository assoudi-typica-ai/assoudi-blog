...
- Oracle AI,  vector search, RAG, and Agents
- In-DB semantic search and retrieval patterns using ONNX Models
- Oracle OCI Data Science (training models from scratch, fine-tuning models, etc.) 
- architecture trade-offs and implementation decisions
- model evaluation and benchmarking
- enterprise AI patterns for Oracle environments

This site also connects my articles, books, GitHub repositories, Hugging Face assets, videos, and selected technical resources.
